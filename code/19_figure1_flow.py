...
box(axa, 0.03, 0.695, 0.94, 0.105,
    ...
    "121,543 non-empty (\u2264150 characters)\n121,292 classifiable \u2192 analysed")
arrow(axa, 0.691, 0.652)

# per-year bar chart (analysed narratives, audited build; sums to 121,292)
years = [2018, 2019, 2020, 2021, 2022, 2023, 2024]
narr = [14303, 16278, 16095, 15547, 17158, 21357, 20554]
trans = {2023}
...
axbar.text(0.02, 0.895, "\u03a3n = 121,292\norange: template\ntransition (2023)",
